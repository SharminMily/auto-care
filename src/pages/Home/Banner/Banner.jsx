...
const Banner = () => {
    return (
        <div className="md:mb-40 mb-56">
            ...
            <div className="lg:top-[420px] lg:left-68 lg:px-32 md:top-80 md:left-48 left-8 top-52 align-middle absolute grid grid-cols- justify-center items-center bg-white p-4 shadow-slate-500 shadow-xl">
                {/* <div>heloo</div>
                <div>hhhooo</div>
                <div>hhhhh</div> */}
                <div className="items-center justify-center align-middle">
                    <div className="font-bold text-center  text-3xl pb-8"><span className="text-red-600 text-5xl">35%</span> Discount Offer</div>
